...
$_LANG['register_template'] = '您的注册验证码为%s。如非本人操作，请忽略本短信。';//短信验证码模版
$_LANG['register_template_other'] = 'your verification code is %s. For account safety, don\'t forward the code to others.';
//短信验证码模版
