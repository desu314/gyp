...
function action_openGyp(){
    ...
    $db = $GLOBALS['db'];
    $user = $GLOBALS['user'];
    //echo openssl_encrypt('main,18338355701,12345678','DES-ECB','1a0dcfbdba61c4cca212ec91bb55af28');die;
    ...
    if($user->login($username, null, 1))
    {
        ...
        $res['err'] = 0;
        $res['err_msg'] = "OK";
        $res['data'] = array("back_url"=>$back_act);
        die($json->encode($res));
    }else{
        $res['err'] = 3;
        $res['err_msg'] = "登录失败!";
